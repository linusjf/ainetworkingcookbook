...
def generate_text(prompt: str, presence_penalty: float = 0.0, frequency_penalty: float = 0.0) -> str | None:
...
def main() -> None:
    ...
    parser.add_argument("--prompt", type=str, default="Explain how to design a class using object-oriented design concepts.",
                       help="Prompt to send to the model (default: 'Explain how to design a class using object-oriented design concepts.')")
